...
namespace MesWcfService.MessageQueue.RemoteClient
{
    public class FirstCheckQueue
    {
        public static string CheckPass(Queue<string[]> queue)
        {
            ...
            DataTable dataSet = null;//mesService.SelectStation(sStationName, "").Tables[0];
            ...
            else
            {
                ...
                //判断上一站位是否通过
                //查询该产品型号的所属站位
                DataTable data = null;// mesService.SelectTypeStation(sTypeNumber).Tables[0];
